...
public class Snake {
    ...
    private Array<SnakePart> body;

    private GridDrawer gridDrawer;

    private TextureRegion headTexture;
    private TextureRegion partTexture;
    private TextureRegion tailTexture;

    public Snake(int headX, int headY, int headRotation, GridDrawer gridDrawer, TextureRegion headTexture, TextureRegion partTexture, TextureRegion tailTexture) {
        body = new Array<>();
